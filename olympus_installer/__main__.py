...
async def botlog (String, Api, Hash):
    ...
    Photo = await Client.upload_file(file='O')
...
if __name__ == "__main__":
    ...
    config['DEFAULT_BIO'] = "@OlympusUserBot"
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://"
    config['WARN_LIMIT'] = "3"
